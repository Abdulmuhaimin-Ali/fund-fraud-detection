    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-8">
        ...
        <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
          <Image src="/MSA.jpg?height=600&width=800" alt="Zakat-Picture" fill className="object-cover" />
          {/* Progress Bar */}
        ...
        <div>
          <h1 className="text-2xl font-bold mb-4 text-black">Zakat Description</h1>
